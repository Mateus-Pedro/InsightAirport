...
import CommunicationlogInfo from "../components/CommunicationlogInfo/index.jsx";
import { ToastContainer, toast } from "react-toastify";

function Communicationlog() {
  const [data, setData] = useState([]);
  const [searchTerm, setSearchTerm] = useState("");
  const api = "https://localhost:7149/api/Communicationlog";
  ...
  const formattedData = airplaneData.map((dado) => ({
    ...dado,
    formattedTimestamp: new Date(dado.timestamp).toLocaleString(),
  }));
  ...
  const filteredData =
    ...
    formattedData.filter(
      (dado) =>
        dado.message.toLowerCase().includes(searchTerm.toLowerCase()) ||
        dado.formattedTimestamp.toLowerCase().includes(searchTerm.toLowerCase())
    );
    ...
    <div>
      ...
      <div className="container">
        <div className="header-container">
          <h1 className="header-title">Communication Log</h1>
          <div className="filter-section">
            <div className="search-container">
              ...
              <input
                ...
                placeholder="Search Timestamp or Message"
                value={searchTerm}
      ...
      <div className="content-table-div">
        <div className="content-table-header">
          <div className="content-table-info">
            <p className="content-table-time">Timestamp</p>
            <p className="content-table-message">Message</p>
          </div>
        </div>
        <div className="content-table">
          {filteredData.length > 0 ? (
            ...
            <div className="content-table-error">
              No communication records today
            </div>
          )}
        </div>
      </div>
